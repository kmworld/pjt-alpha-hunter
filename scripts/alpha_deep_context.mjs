...
function detectNewTerms(ctx) {
  ...
  const GENERIC_BIGRAMS = new Set([
    ...
    // Noise bigrams — not meaningful signals
    "says ai","ai powered","ai powered bug","security mailing",
    "mailing list","ai directed","rise ai","ai directed warfare",
    "the rise","rise of","new ai","ai tool","ai tools",
    "ai model","ai models","ai system","ai systems",
    "ai based","ai driven","ai powered","ai enabled",
    "ai assistant","ai chatbot","ai platform","ai service",
    "this is","this week","this month","what is","how to",
    "the future","future of","state of","state of the",
  ]);
